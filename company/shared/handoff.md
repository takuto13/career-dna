...
4. 7週後（2026-09-19〜）の新規タスク計画
   - CTO指示書（index.html等のSEO freshness更新など）
   - SNS指示書（2027-05-11〜 + 2031/01/29〜バッチ）
5. 本日（07-27）大量セッション起動の問題をたくとへエスカレーション
   - スケジュール設定の見直し（月・水・金のみ起動するよう変更要請）
