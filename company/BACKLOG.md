...
- [→] **Xアカウント継続投稿（07/20〜以降の原稿作成）** `SNS担当`
  ...
  - 2027/02/06〜02/15の原稿（残り7本）：SNS_2026-05-24.md タスク1で指示済み（2026-05-24）・作成予定（x-posts/2026-05-26_原稿.md）
  - 2027/02/16〜以降の原稿：未作成・次回SNS担当が作成
...
- [→] **週次パフォーマンスレポート作成** `CEO`
  ...
  - 第3回：2026-05-25（月）予定（GA4・Search Consoleデータをたくとから受領後に実数入りで作成予定）
