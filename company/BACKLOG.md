...
- [→] **Xアカウント継続投稿（07/20〜以降の原稿作成）** `SNS担当`
  ...
  - 07/20〜07/27の原稿4本：SNS指示書発行済み（SNS_2026-05-14.md）・作成中（2026-05-14）
  - 07/28〜以降の原稿：未作成・次回SNS担当が作成
...
- [→] **index.html コンテンツ追加（LLMOセクション追加）** `CTO`
  - CTO_2026-05-14.mdで指示済み・実行待ち
  - 「AIキャリア診断とは」「こんな人に使ってほしい」「診断結果でできること」3セクション追加

- [→] **about.html 強化** `CTO`
  - CTO_2026-05-14.mdで指示済み・実行待ち
  - analytics-events.js追加・E-E-A-Tコンテンツ追記

- [ ] **llms.txt 新規作成（AIO対策）** `CTO`
  - 2026-05-14 競合調査で新施策として浮上・CTO_2026-05-14.md タスク3に追加
