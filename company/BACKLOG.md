...
- [→] **Xアカウント継続投稿（07/20〜以降の原稿作成）** `SNS担当`
  ...
  - 11/01〜11/15の原稿10本：SNS_2026-05-20.md で作成依頼済み（2026-05-19）・SNS担当が作成予定
  - 11/16〜以降の原稿：未作成・次回SNS担当が作成
...
- [→] **faq.html 新FAQ追加・11月転職KW対応（CTO_2026-05-19.md タスク1）** `CTO`
  - 10月〜11月の転職需要期に対応した新FAQを追加（年末転職・内定後キャリア等）
  - FAQPage JSON-LDも同時更新

- [→] **index.html ページ速度最適化・画像圧縮チェック（CTO_2026-05-19.md タスク2）** `CTO`
  - Core Web Vitals対応・モバイル表示速度改善
  - 不要なCSSの確認

- [→] **about.html Person JSON-LD 追加（CTO_2026-05-19.md タスク3）** `CTO`
  - 運営者（たくと）のPerson JSON-LD追加でE-E-A-T強化
  - GoogleのAuthor表示・ナレッジグラフ接続

- [→] **職人・挑戦者タイプページ「転職成功ポイント」コンテンツセクション追加（CTO_2026-05-20.md タスク1）** `CTO`
  - type-craftsman.html・type-challenger.html にコンテンツ深化セクション追加
  - ロングテールKW「コツコツできる仕事 転職」「行動力がある人 向いてる仕事」対応

- [→] **index.html WebSite JSON-LD（SearchAction）追加（CTO_2026-05-20.md タスク2）** `CTO`
  - Googleサイトリンク検索ボックス促進・エンティティ認識強化

- [→] **全タイプページ・主要ページ 画像alt属性SEO最適化チェック（CTO_2026-05-20.md タスク3）** `CTO`
  - alt属性未設定・不適切な場合に更新
