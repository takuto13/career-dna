...
- [→] **faq.html 就活特化FAQ 3問追加（CTO_2026-05-24.md タスク1）** `CTO 2026-05-24 指示済み`
  - 「就活 自己分析 始め方」「大学生 適職診断 無料」「就活 強み 弱み 見つけ方」KW対応（32問→35問）
  - FAQPage JSON-LD・HTML本文追加・内部リンク付与・sitemap.xml faq.html lastmod更新

- [→] **戦略家・分析者・表現者タイプページ 8問目FAQ追加（CTO_2026-05-24.md タスク2）** `CTO 2026-05-24 指示済み`
  - 「〇〇タイプ 就活 業界・職種」KW対応・Article JSON-LD dateModified → 2026-05-24・sitemap.xml更新

- [→] **llms.txt FAQ件数・就活コンテンツ更新（CTO_2026-05-24.md タスク3）** `CTO 2026-05-24 指示済み`
  - FAQ件数「32問以上」→「35問以上」に更新・就活FAQサマリー追加
