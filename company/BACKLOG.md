...
- [ ] **全8タイプページ FAQ 12問目追加（副業・フリーランス・リモートワーク系KW）** `CTO_2026-05-27.md タスク1`
  - KW：「[タイプ名] 副業」「[タイプ名] フリーランス 向いてる」「[タイプ名] リモートワーク 向いてる」
  - 全8タイプ × 1問、FAQPage JSON-LD + HTML本文両方に追加
  - Article JSON-LD dateModified → 2026-05-27・sitemap.xml全タイプ更新

- [ ] **faq.html 副業・フリーランス・リモートワーク系 FAQ 3問追加（47問体制）** `CTO_2026-05-27.md タスク2`
  - KW：「副業 診断 おすすめ」「リモートワーク 向いてる 自己分析」「副業 始め方 自己分析」
  - FAQPage JSON-LD・HTML本文追加（44問→47問）・meta description「47問以上」に更新

- [ ] **llms.txt 整合更新（47問対応・12問目追加反映）** `CTO_2026-05-27.md タスク3`
  - FAQ件数「44問以上」→「47問以上」・全タイプFAQ「12問以上」に更新
