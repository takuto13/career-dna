...
- [→] **faq.html「転職活動開始時期・年明け転職」FAQ 2問追加（CTO_2026-05-22.md 追加タスク1）** `CTO実施予定`
  - KW：「転職活動 いつ 始める」「年明け 転職 遅い」「1月 転職活動 始め方」対応
  - FAQPage JSON-LD・HTML本文追加（23問→25問）・内部リンク付与

- [→] **jobs.html「年末・年明けエージェント活用」コンテンツセクション追加（CTO_2026-05-22.md 追加タスク2）** `CTO実施予定`
  - KW：「年末 転職エージェント 登録」「年明け転職 エージェント 始め方」対応
  - アフィリエイト誘導強化・sitemap.xml更新

- [→] **sitemap.xml about.html/faq.html/jobs.html lastmod 最終整合確認（CTO_2026-05-22.md 追加タスク3）** `CTO実施予定`
  - 本日更新ページのlastmod 2026-05-22整合確認
