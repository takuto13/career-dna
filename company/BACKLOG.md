...
- [ ] **faq.html「未経験転職・異業種転職・キャリアアップ系」FAQ 3問追加（50問体制）（CTO_2026-05-28.md タスク1）**
  - 狙いKW：「未経験 転職 自己分析 やり方」「異業種転職 向いてる タイプ」「キャリアアップ 転職 自己分析」
  - FAQPage JSON-LD + HTML本文（47問→50問）・meta description更新・sitemap.xml更新

- [ ] **全8タイプページ FAQ 13問目追加（キャリアアップ・昇進転換系KW）（CTO_2026-05-28.md タスク2）**
  - 狙いKW：「[タイプ名] キャリアアップ 方法」「[タイプ名] 昇進 向いてる」
  - FAQPage JSON-LD + HTML本文（12問→13問）・dateModified/sitemap.xml更新

- [ ] **llms.txt 整合更新（50問以上・13問以上）（CTO_2026-05-28.md タスク3）**
