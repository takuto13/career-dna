...
- [ ] **faq.html 夏・ボーナス後転職KW FAQ 3問追加（62問体制）（CTO_2026-05-30.md タスク1）** `CTO待ち`
  - 狙いKW：「ボーナス後 転職 タイミング」「夏採用 中途 自己分析」「夏インターン 前 自己分析」
  - FAQPage JSON-LD + HTML本文（59問→62問）・meta description「62問以上」・sitemap更新

- [ ] **全8タイプページ FAQ 17問目追加（業界適性・転職先絞り方系KW）（CTO_2026-05-30.md タスク2）** `CTO待ち`
  - 狙いKW：「[タイプ名] 向いてる業界」「[タイプ名] 転職先 絞り方」
  - FAQPage JSON-LD + HTML本文（16問→17問）・全8タイプページ対応完了
  - 各タイプ回答にjobs.html（タイプパラメータ付き）内部リンク必須

- [ ] **llms.txt 整合更新（62問以上・17問以上）（CTO_2026-05-30.md タスク3）** `CTO待ち`
