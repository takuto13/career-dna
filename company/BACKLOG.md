...
- [→] **Xアカウント継続投稿（07/06〜以降の原稿作成）** `SNS担当`
  ...
  - 07/06〜07/12の原稿7本：SNS_2026-05-12.md で指示済み・次回SNS担当が作成

###  高優先（今月中）

- [→] **全タイプページ 内部クロスリンク追加** `CTO 2026-05-12指示済み`
  - 全8タイプページ末尾に「他のキャリアタイプも見てみる」セクション追加
  - タイプ間のSEOリンクジュース分配・回遊率向上が目的
  - デザイン変更なし・既存スタイル流用

- [→] **jobs.html SEO強化** `CTO 2026-05-12指示済み`
  - title・meta description・H1/H2・各サービス説明文のキーワード最適化
  - 狙いキーワード：「転職エージェントおすすめ」「キャリア診断 転職」
  - アフィリエイト収益導線ページの検索流入強化
