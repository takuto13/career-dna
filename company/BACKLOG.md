...
- [→] **faq.html 中優先KW FAQ 2問追加（CTO_2026-05-23.md タスク1）** `CTO実行予定 2026-05-23`
  - 「向いてる仕事 5分 登録なし」「強みを知る 転職 診断」KW対応
  - FAQPage JSON-LD・HTML本文両方に追加（既存21問→23問）・sitemap.xml更新

- [→] **about.html E-E-A-Tコンテンツ強化・可視テキスト追加（CTO_2026-05-23.md タスク2）** `CTO実行予定 2026-05-23`
  - 「このサービスを作った理由」「運営者情報」のHTML可視テキスト追加
  - Person JSON-LDと整合・E-E-A-T強化・sitemap.xml更新

- [→] **index.html「選ばれる理由」セクション CSS確認（CTO_2026-05-23.md タスク3）** `CTO実行予定 2026-05-23`
  - `.reasons-section`等の新CSSクラスがstyle.cssに未定義の可能性→表示確認・必要に応じてinlineスタイル修正

- [→] **llms.txt 更新（CTO_2026-05-24.md タスク1）** `CTO実行予定 2026-05-24`
  - FAQ件数「18問」→「23問以上」に更新・「転職成功ポイント」「選ばれる理由」「タイプ別エージェント選び方」コンテンツを反映
  - AI検索白書2026によりAI検索流入急増傾向 → llms.txt最新化でAI検索流入維持・強化

- [→] **index.html meta description KW確認・補強（CTO_2026-05-24.md タスク2）** `CTO実行予定 2026-05-24`
  - 「AI診断 登録不要」「キャリア診断 5分 無料」「適職診断 登録不要 転職」KWの含有確認・必要な場合のみ追記

- [→] **faq.html ページ内FAQ件数テキスト確認（CTO_2026-05-24.md タスク3）** `CTO実行予定 2026-05-24`
  - 本文内に件数ハードコードがある場合のみ更新（ない場合は変更不要）
