...
- [→] **タイプ別詳細ページ作成（8ページ）** `CTO・継続中`
  ...
  - ⚠️ **たくとの承認待ち（2件）** → `company/reports/2026-05-07_CTO_typepage_proposal.md`（戦略家） / `company/requests/design_提案_2026-05-08.md`（分析者）
...
- [→] **Xアカウント継続投稿（05/21〜以降の原稿作成）** `SNS担当`
  ...
  - ⚠️ **たくとが05/21〜05/23の予約投稿設定が必要**（2026-05-19ごろ）
