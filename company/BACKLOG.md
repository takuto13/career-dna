...
- [ ] **faq.html 高単価職種（医療・エンジニア）系 FAQ 3問追加（56問→59問体制）（CTO_2026-05-29.md タスク1）** `CTO待ち`
...
- [ ] **全8タイプページ FAQ 16問目追加（ライフイベント・年齢転職系KW）（CTO_2026-05-29.md タスク2）** `CTO待ち`
  - 狙いKW：「[タイプ名] 産休後 転職」「[タイプ名] 35歳 転職 難しい」「[タイプ名] 転職回数多い 対処法」
  - 高CVRターゲット（35歳・育休後・転職回数多い層）へのリーチ強化
  - FAQPage JSON-LD + HTML本文（15問→16問）・全8タイプページ対応完了

- [ ] **llms.txt 整合更新（59問以上・16問以上）（CTO_2026-05-29.md タスク3）** `CTO待ち`
  - FAQ件数「56問以上」→「59問以上」・タイプFAQ「15問以上」→「16問以上」
  - 医療職・エンジニア職転職FAQ・ライフイベント転職FAQサマリー追加
